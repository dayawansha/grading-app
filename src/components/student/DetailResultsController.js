...
function DetailResultsController() {
    ...
    * */
    ...
    useEffect(() => {
        if (isLoading) {
            if(selectedAssignment != null && selectedCourse != null){
                 ...
                 * API call
                 */
                axios.get(`${process.env.REACT_APP_BASE_URL}${process.env.REACT_APP_FUN_STUDENT_RESULT}${10}${/assignment/}${selectedAssignment}${/course/}${selectedCourse}`)
                    .then(response => {
    ...
    return (
        <div>
            <h1> Detail Results Controller </h1>
            <hr />
            <Row>
                <div>
                    <Col lg={12} sm={6}>
...
export default DetailResultsController;