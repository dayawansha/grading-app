...
function QuestionsStatisticsController() {
    ...
    const columns = [
        ...
        {
            dataField: 'avgCorrect',
            text: 'Average Pass (%)'
        },
        {
            dataField: 'avgIncorrect',
            text: 'Average Fail (%)'
        },
        {
            dataField: 'avgPartially',
            text: 'Average Partially (%)'
        },
        {
            dataField: 'avgTime',
    ...
    useEffect(() => {
        if (isLoading) {
            if(selectedAssignment != null && selectedCourse != null){
                 ...
                 * API call
                 */
                axios.get(`${process.env.REACT_APP_BASE_URL}${process.env.REACT_APP_FUN_STUDENT_RESULT_STATISTCS}${1}${/assignment/}${selectedAssignment}${/course/}${selectedCourse}`)
                    .then(response => {
...
export default QuestionsStatisticsController;